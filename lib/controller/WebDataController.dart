...
class WebDataController extends GetxController{
    ...
    // Per-page loading states — all start as true
  RxMap<int, bool> pageLoadingState = <int, bool>{
    0: true,
    1: true,
    2: true,
    3: true,
  ...
  // Convenience getter/setter for the active page
  bool getPageLoading(int pageIndex) => pageLoadingState[pageIndex] ?? true;

  void setPageLoading(int pageIndex, bool loading) {
    pageLoadingState[pageIndex] = loading;
  }
